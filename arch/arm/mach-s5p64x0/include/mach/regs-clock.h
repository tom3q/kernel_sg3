...
//S5P6442 clock regs are different than S5P64X0
#define S5P6442_APLL_CON		S5P_CLKREG(0x100)
#define S5P6442_MPLL_CON		S5P_CLKREG(0x108)
#define S5P6442_EPLL_CON		S5P_CLKREG(0x110)
#define S5P6442_EPLL_CON_K		S5P_CLKREG(0x114)
#define S5P6442_VPLL_CON		S5P_CLKREG(0x120)

#define S5P6442_CLK_SRC0		S5P_CLKREG(0x200)
#define S5P6442_CLK_SRC1		S5P_CLKREG(0x204)
#define S5P6442_CLK_SRC2		S5P_CLKREG(0x208)

#define S5P6442_CLK_DIV0		S5P_CLKREG(0x300)
#define S5P6442_CLK_DIV1		S5P_CLKREG(0x304)
#define S5P6442_CLK_DIV2		S5P_CLKREG(0x308)
#define S5P6442_CLK_DIV3		S5P_CLKREG(0x30C)

#define S5P6442_OTHERS			S5P_CLKREG(0xE000)

#define S5P6442_CLKDIV0_HCLK_SHIFT	(16)
#define S5P6442_CLKDIV0_HCLK_MASK	(0xF << 16)

#define S5P6442_CLK_GATE_SCLK0	S5P_CLKREG(0x440)
#define S5P6442_CLK_GATE_SCLK1	S5P_CLKREG(0x444)
...
#define ARM_CLK_DIV			S5P6442_CLK_DIV0
#define S5P_EPLL_CON		S5P6442_EPLL_CON
#else
